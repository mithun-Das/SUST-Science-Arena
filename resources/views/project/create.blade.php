                    ...
                    @if(count($languages))
                        ...
                        <div class="panel-body">
                            ...
                            <div class=" form"> 
                                ...
                                {!! Form::open(array('route' => 'project.store' , 'method' => 'post', 'class' => 'cmxform form-horizontal tasi-form')) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        {!! Form::textarea('tech_description', null, array('class' => 'form-control','placeholder' => 'Description of the project', 'row' => 2, 'required')) !!}
                                    </div>
                                </div>
                               ...
                               <!--  <div class="form-group">
                                    {!! Form::label('image', "Image of the project*", array('class' => 'control-label col-lg-2')) !!}
                                    <div class="col-lg-6">
                                        {!! Form::file('image', null, array('class' => 'form-control', 'placeholder' => 'Image of the project', 'required' => 'required')) !!}
                                    </div>
                                </div> -->
                        ...
                        @else
                            <br>
                            <b>You cannot create a project when category is empty. </b>
                        @endif
                    @else
                        <br>
                        <b>You cannot create a project when language is empty. </b>
                    @endif
                </div>
