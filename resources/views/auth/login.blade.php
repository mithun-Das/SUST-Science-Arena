...
<div class="wrapper-page animated">
    <div class="panel panel-color panel-primary">
        <div class="panel-heading" style="background-color: #3ecc6f;">
            <h3 class="text-center m-t-10" ><strong>Dependency Manager </strong> </h3>
        </div>
        <br>
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            @else
                <br>
                <b>Sorry, This option is not working temporarily due to transactional email service problem.We are trying to fix this issue ASAP.</b>
                <br>আরেকটা কথা ! এই পাসওয়ার্ডও ভুইলা যাইতে হইবো ?? 
            @endif
            </div>
        </div>
    </div>
